...
function PrimaryCta({ children }: { children: React.ReactNode }) {
  return (
    <a
      href={demoHref}
      className="inline-flex items-center justify-center gap-3 rounded-lg bg-foreground px-6 py-3.5 text-sm font-semibold text-background transition-all hover:bg-foreground/90"
    >
      <span>{children}</span>
...
function Index() {
  ...
  return (
    <main id="top" className="min-h-screen overflow-hidden bg-background">
      ...
      <section className="bg-muted px-6 py-20 lg:py-28" id="cozumler">
        <div className="mx-auto grid max-w-[1380px] grid-cols-1 items-center gap-12 lg:grid-cols-2 lg:gap-20">
          ...
          <div className="rounded-xl border border-border bg-card p-5 shadow-sm">
            ...
            <div className="mt-5 flex items-center gap-4 rounded-lg bg-primary p-5 text-background">
      ...
      <section className="bg-primary px-6 py-20 text-background lg:py-28">
        <div className="mx-auto grid max-w-[1380px] grid-cols-1 items-end gap-10 lg:grid-cols-2 lg:gap-20">
          <div>
            <span className="text-xs font-bold uppercase tracking-widest text-background/70">Carbonity.ai ile tanışın</span>
            <h2 className="mt-4 font-display text-3xl font-bold leading-tightish tracking-tight md:text-4xl lg:text-5xl">
              ...
              <span className="text-background/40">Yönetin.</span>
            </h2>
          </div>
          <div>
